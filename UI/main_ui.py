...
from PyQt6.QtWidgets import (
    ...
    QLabel, QLineEdit, QPushButton, QFrame, QToolButton, QScrollArea,
)
from PyQt6.QtGui import QIcon, QFont
from PyQt6.QtCore import QSize, Qt

from encrypted_file import EncryptedMessage
from add_password_ui import AddPasswordDialog
from setting_ui import SettingsDialog
from secret_key_ui import SecretKeyDialog
...
# 获取路径
SQLITE_DB_PATH = config.get("db_path", "sqlite_db_path")


class PasswordManager(QMainWindow):
    def __init__(self, position = (100, 100, 1000, 700)):
        super().__init__()
    ...
    def create_sidebar(self):
        ...
        # 导航项
        nav_items = [
            ("所有密码", "icons/all_passwords.png", None),
            ("常用", "icons/frequent.png", None),
            ("社交媒体", "icons/social.png", None),
            ("金融", "icons/finance.png", None),
            ("生成密钥", "icons/work.png", self.generate_key),
            ("回收站", "icons/trash.png", None),
        ...
        avatar = QLabel()
        avatar.setPixmap(QIcon("icons/user.png").pixmap(40, 40))
    ...
    def generate_key(self):
        ...
        # QMessageBox.information(self, "hi", k)
